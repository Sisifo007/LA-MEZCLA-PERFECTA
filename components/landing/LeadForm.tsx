          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4 text-center">
              ...
              <div className="mt-8 pt-6 border-t border-[var(--color-border)] flex flex-col items-center gap-3">
                <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-semibold text-center leading-relaxed">
                  O síguenos en nuestras redes para conocernos
                </p>
                <div className="flex gap-4">
                  <a 
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-lg border border-[var(--color-border)] bg-background/40 hover:bg-background/80 hover:text-[var(--color-gold-light)] hover:border-[var(--color-gold)]/40 hover:scale-[1.02] transition-all text-xs font-semibold text-muted-foreground"
                  >
                    <FacebookIcon className="w-4 h-4 text-[var(--color-gold)]" /> LUMEN OPEN BAR
                  </a>
                  <a 
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-lg border border-[var(--color-border)] bg-background/40 hover:bg-background/80 hover:text-[var(--color-gold-light)] hover:border-[var(--color-gold)]/40 hover:scale-[1.02] transition-all text-xs font-semibold text-muted-foreground"
                  >
                    <InstagramIcon className="w-4 h-4 text-[var(--color-gold)]" /> @lumenopenbar
                  </a>
                </div>
              </div>
            </div>
